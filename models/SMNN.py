...
# structure = [(128,64),(16,16),(64,32)] # defined in the original github
# [(128,128),(16,16),(64,64)]
class ScalableMonotonicNeuralNetwork(torch.nn.Module):
    def __init__(self,
                 input_size: int = 129, 
                 mono_size: int = 1,
                 mono_feature: np.ndarray = np.asarray([128]),
                 output_size: int = 36,
                 exp_unit_size: Tuple = (128,128),
                 relu_unit_size: Tuple = (128,128),
                 conf_unit_size: Tuple = (32,32),
        ...
        self.fclayer = fully_connected_layer(exp_unit_size[len(exp_unit_size)-1] + conf_unit_size[len(exp_unit_size)-1] + relu_unit_size[len(relu_unit_size)-1],self.output_size)
