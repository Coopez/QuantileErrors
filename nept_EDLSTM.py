...
from res.model import EncoderDecoderLSTM
...
train_loader = torch.utils.data.DataLoader(data_train, batch_size=params['batch_size'], shuffle=True)
...
# Define the model
model = EncoderDecoderLSTM(params['input_size'], params['hidden_size'], params['num_layers'], params['horizon']).to(device)
